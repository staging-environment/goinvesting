        ...
        <form action="{{ route('admin.user.create') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="space-y-1 sm:col-span-2">
                    ...
                    <x-text-input id="monthly_spend_limit" type="number" step="0.01" name="monthly_spend_limit" placeholder="Ej: 100000 (Opcional)" class="w-full" :value="old('monthly_spend_limit')" />
