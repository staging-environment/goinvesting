...
<body class="min-h-screen flex flex-col antialiased selection:bg-indigo-500 selection:text-white">
    ...
    <header class="sticky top-0 z-40 w-full bg-gradient-to-r from-[#0d122b] via-[#1a1f4c] to-[#0f113a] backdrop-blur-md border-b border-indigo-500/45 shadow-lg shadow-indigo-500/15">
        <div class="max-w-7xl mx-auto px-4 lg:px-6 h-16 flex items-center justify-between gap-4">
            ...
            <div class="relative w-40 lg:w-48 xl:w-56 mx-2 hidden md:block shrink-0">
                <div class="relative">
            ...
            <!-- Navigation Links -->
            <div class="hidden md:flex items-center gap-3 lg:gap-4 text-[12px] lg:text-[13px] font-bold whitespace-nowrap">
                @auth
                    ...
                    @endphp
                    <a href="{{ route('getting-started') }}" class="transition flex items-center gap-1 shrink-0 {{ $notConfigured ? 'px-2 py-1 rounded-lg text-[11px] bg-amber-500/10 text-amber-400 border border-amber-500/35 font-extrabold animate-pulse hover:bg-amber-500/20 hover:text-amber-300' : 'text-slate-350 hover:text-white' }}">
                        @if($notConfigured)
